...
- [willcl-ark.github.io/dnsseedrs](https://willcl-ark.github.io/dnsseedrs/) - DNS-seeder health dashboard (visualisation of seeder answers, no dump export).
- [census.yonson.dev](https://census.yonson.dev/) - listening-node feature-acceptance ratios (aggregates only).
- [bitcoin-data/getrawaddrman](https://github.com/bitcoin-data/getrawaddrman) - historical `getrawaddrman` exports of Bitcoin Core nodes; complementary (addrman view, not crawler view) and already archived as a git dataset.
- [peer.observer](https://demo.peer.observer/) / [lopp.net node stats](https://www.lopp.net/bitcoin-information/statistics-metrics.html) - live monitoring / link collections, no snapshots.
